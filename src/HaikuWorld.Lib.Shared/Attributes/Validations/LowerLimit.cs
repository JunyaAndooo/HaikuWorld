...
public sealed class LowerLimit<T> : Attribute, IValidationAttribute<T> where T : notnull, IComparable<T>
{
    private readonly T underValue;

    public LowerLimit(T underValue) => this.underValue = underValue;
